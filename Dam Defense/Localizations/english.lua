...
return {
	...
	wikiText_securityofficerJob = 'An override of the vanilla security officer job. Antag safe job, a member of security. There can only be three enforcers at a time. The mayor may get replaced with another member of security depending on the result of an election.',
