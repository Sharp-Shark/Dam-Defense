...
DD.lootTables = {
	['outposttrashcan'] = {
		attempts = 3,
		chance = 0.4,
		{identifier = 'fulguriumfuelrodvolatile', weight = 0.2},
		{identifier = 'tbsyringe', weight = 0.1},
		{identifier = 'uex', weight = 0.2},
		{identifier = 'detonator', weight = 0.2},
		{identifier = 'pipegun', weight = 0.2},
		{identifier = 'flaregun', weight = 0.2},
		{identifier = 'wifitrigger', weight = 0.2},
		{identifier = 'divingknife', weight = 0.5},
		{identifier = 'redwire', weight = 0.5, maxAmount = 4},
		{identifier = 'chloralhydrate', weight = 0.5, maxAmount = 2},
		{identifier = 'meth', weight = 0.5, maxAmount = 2},
		{identifier = 'antidama2', weight = 0.5, maxAmount = 2},
		{identifier = 'rum', weight = 0.5},
		{identifier = 'nitroglycerin', weight = 0.5},
